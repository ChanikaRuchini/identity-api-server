...
import org.wso2.carbon.identity.api.server.choreo.management.v1.*;
import org.wso2.carbon.identity.api.server.choreo.management.v1.model.*;
...
public interface ChoreoConfigurationsApiService {
      ...
      public Response updateChoreoConfiguration(String referenceName, ChoreoconfigurationUpdateRequest choreoconfigurationUpdateRequest);
}
